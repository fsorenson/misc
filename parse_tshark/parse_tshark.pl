...
sub elaborate_smb {
	...
	my %smb_fields = (
		...
		"smb.cmd" => {
			...
			26 => "Read Raw",
			27 => "Read MPX",
			28 => "Read MPX Secondary",
			29 => "Write Raw",
			30 => "Write MPX",
			31 => "Write MPX Secondary",
			32 => "Write Complete",
			33 => "Query Server (reserved)",
			34 => "Set Information2",
			35 => "Query Information2",
			36 => "Locking AndX",
			37 => "Trans",
			38 => "Trans Secondary",
			39 => "IOCTL",
			...
			46 => "Read AndX",
			47 => "Write AndX",
			48 => "New File Size (reserved)",
			49 => "Close And Tree Disconnect",
			50 => "Trans2",
			51 => "Trans2 Secondary",
			52 => "Find Close2",
			53 => "Find Notify Close",
			112 => "Tree Connect",
			113 => "Tree Disconnect",
			114 => "Negotiate Protocol",
			115 => "Session Setup AndX",
			116 => "Logoff AndX",
			117 => "Tree Connect AndX",
			128 => "Query Information Disk",
			129 => "Search",
			130 => "Find",
			131 => "Find Unique",
			132 => "Find Close",
			160 => "NT Trans",
			161 => "NT Trans Secondary",
			162 => "NT Create AndX",
			163 => "unknown-0xA3",
			164 => "NT Cancel",
			165 => "NT Rename",
			192 => "Open Print File",
			193 => "Write Print File",
			194 => "Close Print File",
			195 => "Get Print Queue",
			208 => "Send Single Block Message",
			209 => "Send Broadcast Message",
			210 => "Forward User Name",
			211 => "Cancel Forward",
			212 => "Get Machine Name",
			213 => "Send Start of Multi-block Message",
			214 => "Send End of Multi-block Message",
			215 => "Send Text of Multi-block Message",
			216 => "SMBreadbulk",
			217 => "SMBwritebulk",
			218 => "SMBwritebulkdata",
			254 => "SMBinvalid",
		},
		"smb2.cmd" => {
